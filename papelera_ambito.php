        ...
        if ($total_sql > 0) {
            for ($i = 1; $i <= $total_sql; $i++) {
                if (isset($chkreprovar[$i]) && $chkreprovar[$i] == "SI") {
                    ...
                    // Actualizar el registro del ámbito
                    $consulta = "UPDATE ambito SET borrado = 0 
                               WHERE cod_ambito = ?";
...
<head>
    ...
    <title>PAPELERA DE RECICLAJE - ÁMBITO</title>
    <style>
        /* Reset básico */
        body, td, th {
...
<body>
    <div class="container">
        <form id="form1" name="form1" method="post" action="papelera_ambito.php" class="form-container">
            <div class="caja">
                <div class="titulo-principal sombra">
                    PAPELERA DE RECICLAJE DE ÁMBITO
                </div>
            ...
            <div>
                <?php
                $consulta_sql = "SELECT * FROM ambito WHERE borrado = 1";
                    ...
                    ?>
                        <tr style="background-color: <?php echo $color; ?>">
                            ...
                            <td style="text-align: center;">
                                <?php echo htmlspecialchars($datos_sql['cod_ambito']); ?>
                                <input name="cod_promover<?php echo $i; ?>" type="hidden" 
                                       value="<?php echo htmlspecialchars($datos_sql['cod_ambito']); ?>">
                            </td>
                            <td style="text-align: left;">
                                <?php echo htmlspecialchars($datos_sql['nom_ambito']); ?>
                            </td>
                            <td style="text-align: center;">
